...
<body>
    ...
    <!-- Page Header End -->
            ...
            <!-- Product start -->
            <a href="http://localhost/html/logout" class="btn btn-danger ml-3">Sign Out of Your Account</a>
...
<div id="product-grid">
    ...
    <div class="container-fluid  text-light footer my-6 mb-0 py-5 wow fadeIn" >
